...
class RiskMatrix extends React.Component {
     ...
     */
    render() {
        const { id, className, loadingText, showViewSelector, dataSource, columns, } = this.props;
            ...
            return (React.createElement("div", { className: className },
                ...
                items.length === 0
                    ...
                    : (React.createElement("div", null,
                        ...
                        React.createElement("div", { hidden: !dataSource },
    ...
    fetchData() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.props.dataSource) {
                const spSearchItems = yield this.searchItems(dataSource);
    ...
    */
    searchItems(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const [dataSource] = yield this.dataSourcesList.items.filter(`Title eq '${name}'`).get();
            if (dataSource) {
