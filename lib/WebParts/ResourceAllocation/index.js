...
class ResourceAllocation extends _BaseWebPart_1.default {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement(MessageBar_1.MessageBar, null,
                React.createElement("div", { dangerouslySetInnerHTML: { __html: String.format(Resources_1.default.getResource("ResourceAllocation_LinkText"), `${url}/Lists/ResourceAllocation/AllItems.aspx?Source=${encodeURIComponent(window.location.href)}`) } })),
    ...
    searchAllocationItems() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let queryTemplate = (this.props.dataSource === DataSource_1.default.SearchCustom && this.props.queryTemplate) ? this.props.queryTemplate : "";
            if (dataSource) {
    ...
    fetchAvailabilityItems() {
        return __awaiter(this, void 0, void 0, function* () {
            const web = this.props.projectRoot ? new sp_1.Web(this.props.projectRoot) : sp_1.sp.web;
            const itemsAvailabilityList = web.lists.getByTitle(Resources_1.default.getResource("Lists_ResourceAllocation_Title"));
