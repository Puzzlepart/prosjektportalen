...
class ResourceAllocation extends _BaseWebPart_1.default {
    ...
    searchAllocationItems() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dataSource) {
                try {
                    const searchSettings = Object.assign({ QueryTemplate: dataSource.GtDpSearchQuery }, this.props.searchConfiguration);
    ...
    fetchAvailabilityItems() {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsAvailability = yield sp_1.sp.web.lists.getByTitle(Resources_1.default.getResource("Lists_ResourceAllocation_Title"))
                .items
