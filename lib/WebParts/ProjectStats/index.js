...
class ProjectStats extends _BaseWebPart_1.default {
    ...
    constructor(props) {
        ...
        if (this.props.projectRoot) {
            this.statsFieldsList = new sp_1.Web(this.props.projectRoot).lists.getByTitle(Resources_1.default.getResource("Lists_StatsFieldsConfig_Title"));
            this.chartsConfigList = new sp_1.Web(this.props.projectRoot).lists.getByTitle(Resources_1.default.getResource("Lists_ChartsConfig_Title"));
        }
        else {
            this.statsFieldsList = sp_1.sp.web.lists.getByTitle(Resources_1.default.getResource("Lists_StatsFieldsConfig_Title"));
            this.chartsConfigList = sp_1.sp.web.lists.getByTitle(Resources_1.default.getResource("Lists_ChartsConfig_Title"));
        }
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "ms-Grid" },
            React.createElement("div", { className: "ms-Grid-row" }, this.renderCommandBar()),
