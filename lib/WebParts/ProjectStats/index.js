...
class ProjectStats extends _BaseWebPart_1.default {
    ...
    constructor(props) {
        ...
        this.statsFieldsList = web.lists.getByTitle(Resources_1.default.getResource("Lists_StatsFieldsConfig_Title"));
        this.chartsConfigList = web.lists.getByTitle(Resources_1.default.getResource("Lists_ChartsConfig_Title"));
    }
    componentDidMount() {
