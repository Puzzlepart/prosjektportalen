    ...
    */
    ...
    renderInner() {
        ...
        return charts
            ...
            .map((chart, idx) => (React.createElement(ProjectStatsChart_1.default, { key: idx, chart: chart, showSettings: this.state.showChartSettings, listServerRelativeUrl: this.state.chartsConfigListProperties.RootFolder.ServerRelativeUrl })));
    }
    /**
