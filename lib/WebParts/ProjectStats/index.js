...
class ProjectStats extends _BaseWebPart_1.default {
    ...
    constructor(props) {
        ...
        const web = this.props.rootWeb ? this.props.rootWeb : sp_1.sp.web;
    ...
    render() {
        ...
        return (React.createElement("div", { className: "ms-Grid" },
            React.createElement("div", { className: "ms-Grid-row" }, this.props.renderCommandBar &&
    ...
    */
    ...
    renderInner() {
        ...
        return charts
            ...
            .map((chart, idx) => (React.createElement(ProjectStatsChart_1.default, { key: idx, chart: chart, showSettings: this.state.showChartSettings, renderCommandBar: this.props.renderCommandBar, listServerRelativeUrl: this.state.chartsConfigListProperties.RootFolder.ServerRelativeUrl })));
    }
    /**
    ...
    fetchData(view) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const [{ views }, fieldsSpItems, chartsSpItems, chartsConfigListProperties, chartsConfigListContentTypes, statsFieldsListContenTypes] = yield Promise.all([
                ...
                const config = { charts, data, views, contentTypes, currentView, chartsConfigListProperties };
                return config;
            }
            catch (err) {
                throw err;
