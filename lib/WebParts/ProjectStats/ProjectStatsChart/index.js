    ...
    render() {
        ...
        return (React.createElement("div", { className: `ms-Grid-col ${this._getLayoutClassNames()}`, style: { marginTop: "75px" } },
            React.createElement("div", { className: "ms-Grid" },
                React.createElement(ProjectStatsChartSettings_1.default, { hidden: !this.props.showSettings, chart: this.state.chart, onItemChanged: this.onItemChanged, onWidthChanged: this.onChangeWidth }),
