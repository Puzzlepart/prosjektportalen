...
const ProjectStatsChartSettingsProps_1 = require("./ProjectStatsChartSettingsProps");
...
class ProjectStatsChartSettings extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "ms-Grid-row", hidden: this.props.hidden },
            React.createElement("div", { className: "ms-Grid-col ms-sm12" }, this.props.showCommandBar &&
...
ProjectStatsChartSettings.defaultProps = ProjectStatsChartSettingsProps_1.ProjectStatsChartSettingsDefaultProps;
