...
export const RiskList: any = {
    ...
    Columns: [
        ...
        {
            key: "Title",
            name: "Tittel (Hendelse og konsekvens)",
            fieldName: "Title",
            isMultiline: true,
            maxWidth: 300,
            minWidth: 100,
        ...
        {
            key: "GtRiskProbability",
            name: "Sannsynlighet",
            fieldName: "GtRiskProbability",
            maxWidth: 30,
        },
        {
            key: "GtRiskConsequence",
            name: "Konsekvens",
            fieldName: "GtRiskConsequence",
            maxWidth: 30,
        },
        {
            key: "GtRiskFactor",
            name: "Risiko",
            fieldName: "GtRiskFactor",
            maxWidth: 30,
        },
        {
            key: "GtRiskAction",
            name: "Tiltak",
            fieldName: "GtRiskAction",
            maxWidth: 300,
            minWidth: 100,
            isMultiline: true,
            columnActionsMode: 0,
