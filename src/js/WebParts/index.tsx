...
const WebPartComponents: WebPartComponent[] = [
    ...
    new WebPartComponent(BenefitsOverview.displayName, "pp-benefitsoverview-search", <BenefitsOverview dataSource={DataSource.Search} groupByOptions={[{ name: Localization.getResource("String_Project"), key: "SiteTitle" }]} />),
