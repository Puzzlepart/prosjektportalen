...
export const SummaryView = ({ activePhase }: ISummaryViewProps) => {
    const listViewUrl = `${_spPageContextInfo.webAbsoluteUrl}/${__.getResource('DefaultView_PhaseChecklist_Url')}?FilterField1=GtProjectPhase&FilterValue1=${activePhase.Name}`
    return (
        <div className='inner'>
            <ul
