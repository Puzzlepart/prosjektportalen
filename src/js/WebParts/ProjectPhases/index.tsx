...
export default class ProjectPhases extends BaseWebPart<IProjectPhasesProps, IProjectPhasesState> {
        ...
        return (
            <ul>
                {phases.map((phase, index) => {
                    ...
                    const projectPhaseProps: IProjectPhaseProps = {
                        phase,
                        phaseIterations,
                        requestedPhase,
                        classList,
    ...
    private renderChangePhaseDialog(): JSX.Element {
        ...
        const changePhaseDialogProps: IChangePhaseDialogProps = {
            newPhase,
            activePhase,
            nextPhase,
            gateApproval: false,
    ...
    * @param {string} requestedPhase Requesed phase
    */
    private async updateProjectProperties(phase: PhaseModel, changePhaseDialogResult: ChangePhaseDialogResult, requestedPhase = '') {
        ...
        const valuesToUpdate: { [key: string]: string } = {
