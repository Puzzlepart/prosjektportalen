...
const RiskMatrixCells: Array<IRiskMatrixCell[]> = [
    [
        {
            ...
            className: "risk-header ms-Grid-col ms-sm2",
        },
        {
    ...
    [
        ...
        },
        {
            ...
            className: "risk-matrix-cell positive-cell ms-Grid-col ms-sm2",
            consequence: 1,
            probability: 5,
        },
        {
            cellValue: "",
            cellType: RiskMatrixCellType.Cell,
            className: "risk-matrix-cell neutral-cell ms-Grid-col ms-sm2",
            consequence: 2,
            probability: 5,
        },
        {
            cellValue: "",
            cellType: RiskMatrixCellType.Cell,
            className: "risk-matrix-cell negative-cell ms-Grid-col ms-sm2",
            consequence: 3,
            probability: 5,
        },
        {
