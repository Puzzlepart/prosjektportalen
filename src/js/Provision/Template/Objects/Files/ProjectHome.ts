...
export default function ProjectHome(language: number): IFile {
    return {
        Folder: "SitePages",
        ...
        WebParts: [
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_ProjectPhases_Title", language),
                Zone: "LeftColumn",
                Order: 0,
                Contents: {
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_Timeline_Title", language),
                Zone: "LeftColumn",
                Order: 1,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_Timeline_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
                ...
                },
                {
                    name: "ViewName",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_Timeline_ViewName", language),
                },
                {
                    name: "TimelineType",
                    type: "string",
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_DocumentsCurrentPhase_Title", language),
                Zone: "LeftColumn",
                Order: 2,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_DocumentsCurrentPhase_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
                ...
                ListView: {
                    List: RESOURCE_MANAGER.getResource("Lists_Documents_Title", language),
                    View: {
                        Title: "",
            ...
            },
            {
                ...
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("Lists_BenefitsAnalysis_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
                ...
                ListView: {
                    List: RESOURCE_MANAGER.getResource("Lists_BenefitsAnalysis_Title", language),
                    View: {
                        Title: "",
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_ProjectInfo_Title", language),
                Zone: "RightColumn",
                Order: 0,
                Contents: {
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_SiteFeed_Title", language),
                Zone: "RightColumn",
                Order: 1,
                Contents: {
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_UncertaintiesCurrentPhase_Title", language),
                Zone: "RightColumn",
                Order: 2,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_UncertaintiesCurrentPhase_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
                ...
                ListView: {
                    List: RESOURCE_MANAGER.getResource("Lists_Uncertainties_Title", language),
                    View: {
                        Title: "",
