...
export default function Nofilter(language: number): IFile {
    return {
        Folder: "SitePages",
        ...
        WebParts: [
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_Tasks_Title", language),
                Zone: "LeftColumn",
                Order: 0,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_Tasks_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_Documents_Title", language),
                Zone: "LeftColumn",
                Order: 1,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_Documents_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
            ...
            {
                Title: RESOURCE_MANAGER.getResource("WebPart_Uncertainties_Title", language),
                Zone: "RightColumn",
                Order: 1,
                PropertyOverrides: [{
                    name: "Title",
                    type: "string",
                    value: RESOURCE_MANAGER.getResource("WebPart_Uncertainties_Title", language),
                },
                {
                    name: "ListUrl",
                    type: "string",
